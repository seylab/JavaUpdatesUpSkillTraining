...
public class PredicateFunctionalInterface {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> nums2 = new ArrayList<>(Arrays.asList(10,10,10,20,20,30,30,40,40,50,60,70,80));
        ...
        List<Integer> nums3 = new ArrayList<>(Arrays.asList(10,10,10,20,20,30,30,40,40,50,60,70,80));
